...
MODEL_NAME = "gradientboosting_regressor"
SUPPORTED_PROBLEM_TYPES = ["regression"]


def _build_pipeline(**est_kwargs) -> Pipeline:
    return Pipeline([("est", GradientBoostingRegressor(**est_kwargs))])
...
def train_model(
    ...
    scale: bool = True,  # kept for API compatibility, GBR is scale-invariant
    **kwargs,
