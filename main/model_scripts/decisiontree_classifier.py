...
def _build_pipeline(**est_kwargs) -> Pipeline:
    return Pipeline([("est", DecisionTreeClassifier(**est_kwargs))])
...
def train_model(
    ...
    scale: bool = True,  # kept for API compatibility, decision trees are scale-invariant
    **kwargs,
