...
from main.model_scripts.elasticnet import Model, MODEL_NAME


def test_elasticnet_model_training(tmp_path):
    """
    Test that the ElasticNet model trains properly and returns
    ...
    model_script = Model()
    save_file = tmp_path / "elasticnet_model.joblib"
