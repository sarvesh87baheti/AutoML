...
from main.model_scripts.svm import Model, MODEL_NAME


def test_svm_model_training(tmp_path):
    """
    Test that the SVM model trains properly and returns correct outputs.
    """

    X_train = np.array([[1, 2], [2, 3], [3, 3.5], [4, 5]])
    y_train = np.array([0, 0, 1, 1])

    model_script = Model()
    save_file = tmp_path / "svm_model.joblib"
